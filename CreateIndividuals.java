...
@Test	
	public void extentReport() throws IOException {
		// set physical report path
				...
				ExtentTest test = extent.createTest("Marathon", "Saleforce is running successfully");
				test.assignAuthor("Ranjith");
				test.assignCategory("Smoke Testing");
			
				//Level of status
				//add snapshot .give path and end with build();
				test.pass("enter username", MediaEntityBuilder.createScreenCaptureFromPath(".././snap/Tattoo.jpg").build());
